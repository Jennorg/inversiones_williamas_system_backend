...
import { productSchema } from './product.js'; // Para incluir detalles del producto
...
export const salesOrderItemSchema = z.object({
  ...
  product: productSchema.partial().optional(), // Para incluir detalles del producto si se carga
});
